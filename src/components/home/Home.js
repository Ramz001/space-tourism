...
function Home() {
  ...
  return (
    <main
      className="bg-no-repeat w-full h-full lg:pt-[14rem] desktop:pt-[15rem] lg:pb-[8rem] px-32 flex flex-col xl:flex-row items-center xl:justify-between font-main"
      style={imgStyle}
    >
